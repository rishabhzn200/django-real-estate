...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=30, default="+12345678901")
    about_me = models.TextField(verbose_name=_("About me"), default="Say something about yourself")
    license = models.CharField(verbose_name="Real Estate License", max_length=20, blank=True, null=True)
    ...
    city = models.CharField(verbose_name=_("City"), max_length=180, default="New York", blank=False, null=False)
